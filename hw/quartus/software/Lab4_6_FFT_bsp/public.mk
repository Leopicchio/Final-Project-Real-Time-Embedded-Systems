...
# setting SOPC_SYSID_BASE_ADDRESS is 0x8041078
SOPC_SYSID_FLAG += --sidp=0x8041078
ELF_PATCH_FLAG  += --sidp 0x8041078

# The SOPC Timestamp 
# setting SOPC_TIMESTAMP is 1592151430
SOPC_SYSID_FLAG += --timestamp=1592151430
ELF_PATCH_FLAG  += --timestamp 1592151430
...
# setting hal.stderr is jtag_uart_FFT
ELF_PATCH_FLAG  += --stderr_dev jtag_uart_FFT

# Slave descriptor of STDIN character-mode device. This setting is used by the 
# ALT_STDIN family of defines in system.h. none 
# setting hal.stdin is jtag_uart_FFT
ELF_PATCH_FLAG  += --stdin_dev jtag_uart_FFT
...
# setting hal.stdout is jtag_uart_FFT
ELF_PATCH_FLAG  += --stdout_dev jtag_uart_FFT
