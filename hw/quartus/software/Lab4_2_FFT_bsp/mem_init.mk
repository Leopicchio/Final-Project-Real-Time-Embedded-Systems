...
MEM_0 := main_system_onchip_memory_nios2_FFT
$(MEM_0)_NAME := onchip_memory_nios2_FFT
...
$(MEM_0)_HIERARCHICAL_PATH := onchip_memory_nios2_FFT
$(MEM_0)_WIDTH := 32
...
onchip_memory_nios2_FFT: check_elf_exists $(MEM_INIT_DIR)/$(MEM_0).hex $(HDL_SIM_DIR)/$(MEM_0).dat $(HDL_SIM_DIR)/$(MEM_0).sym
