...
# Memory: onchip_memory_nios2_FFT
MEM_1 := main_system_onchip_memory_nios2_FFT
$(MEM_1)_NAME := onchip_memory_nios2_FFT
...
$(MEM_1)_HIERARCHICAL_PATH := onchip_memory_nios2_FFT
$(MEM_1)_WIDTH := 32
$(MEM_1)_HEX_DATA_WIDTH := 32
$(MEM_1)_ENDIANNESS := --little-endian-mem
$(MEM_1)_CREATE_LANES := 0

.PHONY: onchip_memory_nios2_FFT
onchip_memory_nios2_FFT: check_elf_exists $(MEM_INIT_DIR)/$(MEM_1).hex $(HDL_SIM_DIR)/$(MEM_1).dat $(HDL_SIM_DIR)/$(MEM_1).sym
