...
(
    ...
    localparam PAD9 = log2ceil(64'h41078 - 64'h41070); 
    localparam PAD10 = log2ceil(64'h8000000 - 64'h4000000); 
    localparam PAD11 = log2ceil(64'h8041020 - 64'h8041000); 
    localparam PAD12 = log2ceil(64'h8041078 - 64'h8041070); 
    localparam PAD13 = log2ceil(64'h8041080 - 64'h8041078); 
    // -------------------------------------------------------
    ...
    // ( 0x41050 .. 0x41060 )
    if ( {address[RG:PAD7],{PAD7{1'b0}}} == 28'h41050   ) begin
    ...
    // ( 0x41070 .. 0x41078 )
    if ( {address[RG:PAD9],{PAD9{1'b0}}} == 28'h41070   ) begin
    ...
    // ( 0x8041000 .. 0x8041020 )
    if ( {address[RG:PAD11],{PAD11{1'b0}}} == 28'h8041000   ) begin
            src_channel = 21'b01000000000000;
            src_data[PKT_DEST_ID_H:PKT_DEST_ID_L] = 19;
    end

    // ( 0x8041070 .. 0x8041078 )
    if ( {address[RG:PAD12],{PAD12{1'b0}}} == 28'h8041070   ) begin
            src_channel = 21'b00100000000000;
            src_data[PKT_DEST_ID_H:PKT_DEST_ID_L] = 9;
    end

    // ( 0x8041078 .. 0x8041080 )
    if ( {address[RG:PAD13],{PAD13{1'b0}}} == 28'h8041078  && read_transaction  ) begin
