...
(
    ...
    localparam PAD7 = log2ceil(64'h8041070 - 64'h8041060); 
    localparam PAD8 = log2ceil(64'h8041078 - 64'h8041070); 
    localparam PAD9 = log2ceil(64'h8041080 - 64'h8041078); 
    localparam PAD10 = log2ceil(64'h8041088 - 64'h8041080); 
    // -------------------------------------------------------
    // Work out which address bits are significant based on the
    // address range of the slaves. If the required width is too
    // large or too small, we use the address field width instead.
    // -------------------------------------------------------
    localparam ADDR_RANGE = 64'h8041088;
    ...
    // ( 0x8041060 .. 0x8041070 )
    if ( {address[RG:PAD7],{PAD7{1'b0}}} == 28'h8041060   ) begin
            src_channel = 21'b00000100000;
            src_data[PKT_DEST_ID_H:PKT_DEST_ID_L] = 5;
    end

    // ( 0x8041070 .. 0x8041078 )
    if ( {address[RG:PAD8],{PAD8{1'b0}}} == 28'h8041070   ) begin
            src_channel = 21'b00000000100;
            src_data[PKT_DEST_ID_H:PKT_DEST_ID_L] = 9;
    end

    // ( 0x8041078 .. 0x8041080 )
    if ( {address[RG:PAD9],{PAD9{1'b0}}} == 28'h8041078  && read_transaction  ) begin
            src_channel = 21'b00000000001;
            src_data[PKT_DEST_ID_H:PKT_DEST_ID_L] = 18;
    end

    // ( 0x8041080 .. 0x8041088 )
    if ( {address[RG:PAD10],{PAD10{1'b0}}} == 28'h8041080   ) begin
